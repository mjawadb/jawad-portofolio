...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed top-0 left-0 w-8 h-8 rounded-full border-2 pointer-events-none z-[10000] mix-blend-difference hidden md:flex items-center justify-center overflow-hidden will-change-transform"
        animate={{
      ...
      <motion.div
        className="fixed top-0 left-0 w-2 h-2 bg-white rounded-full pointer-events-none z-[10000] mix-blend-difference hidden md:block drop-shadow-md will-change-transform"
        animate={{
